/**
 * Predicate System - Ported from PTR2e
...
/**
 * Predicate class extends Array to provide predicate evaluation functionality
 */
class Predicate extends Array {
  ...
  /** Is this an array of predication statements? */
